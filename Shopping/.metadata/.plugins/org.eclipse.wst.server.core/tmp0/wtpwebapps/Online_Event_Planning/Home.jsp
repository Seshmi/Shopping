...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/Styles/HomeNew.css">
...
<!--hero section-->
    <div class="hero">
      <img src="photos/noiseporn-JNuKyKXLh8U-unsplash.jpg" alt="" />
      <div>
        <h1>PlanX</h1>
        <center><h2>Let's make a memorable day with Us</h2></center>
       
        <a href="Register.jsp">Manager Register</a>
