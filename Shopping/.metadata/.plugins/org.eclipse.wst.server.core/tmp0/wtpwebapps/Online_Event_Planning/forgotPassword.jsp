...
<link rel="stylesheet" href="${pageContext.request.contextPath}/Styles/forgotPassword.css">
...
<!--Header starts-->
    ...
    <!--header ends-->
			...
			<form class="login-form"   name="retype" action="${pageContext.request.contextPath}/ForgotServlet"  onsubmit="return pass()" method="POST">

				<center><h1 class="ha1">Change Your Password</h1></center>
				...
				<center><input type="password" placeholder="Enter Your New Password" id="newpass" name="password" pattern = ".{8,}"required></center>
				</div>
				...
				<center><a href="Login.jsp"><input type="submit" class="logbtn" value="Update" name="submit"></a></center>
